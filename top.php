	 <div class="header-top">
		 <!--container-->
		  <div class="container">
			 <div class="top-nav">
						<div class="logo">
						<a href="#"><img src="images/logo.png" id="section-1" height="50px" width="200px" style="padding-bottom: 15px;" alt=""/></a>
						</div>
						<div class="menu">
						<ul id="nav">
                       ...
                       <!-- <li><a href="category.php" onclick="javascript:window.open('category.php','_self')">Category</a></li>  -->                           
							<li><a href="category.php" onclick="javascript:window.open('category.php','_self')">LogIn</a></li>
							 <li><a href="index.php#section-4"   onclick="javascript:window.open('index.php#section-4','_self')">                            Categories</a></li>
